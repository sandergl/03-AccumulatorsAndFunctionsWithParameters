...
def run_test_digits_in_cube():
    ...
    # Test 2:
    expected1 = 1
    answer1 = digits_in_cube(100)
    print('Test 2 expected:', expected1)
    print('       actual:  ', answer1)

    # Test 3:
    expected2 = 8
    answer2 = digits_in_cube(2)
    print('Test 3 expected:', expected2)
    print('       actual:  ', answer2)
...
def run_test_digits_in_power():
    ...
    # Test 2:
    expected1 = 1
    answer1 = digits_in_power(100, 34)
    print('Test 2 expected:', expected1)
    print('       actual:  ', answer1)

    # Test 3:
    expected2 = 10
    answer2 = digits_in_power(2, 6)
    print('Test 3 expected:', expected2)
    print('       actual:  ', answer2)
...
def run_test_fancy_sums_of_digits():
    ...
    # Test 2:
    expected1 = 19084
    answer1 = fancy_sums_of_digits(2)
    print('Test 2 expected:', expected1)
    print('       actual:  ', answer1)
